...
defaultproperties {
    ...
    mapIndexes(11)=(mapname="kf-forgotten",achvIndex=29)
    mapIndexes(12)=(mapname="kf-frightyard",achvIndex=26)
    mapIndexes(13)=(mapname="kf-hell",achvIndex=28)
    mapIndexes(14)=(mapname="kf-hellride",achvIndex=21)
    mapIndexes(15)=(mapname="kf-hillbillyhorror",achvIndex=22)
    mapIndexes(16)=(mapname="kf-hospitalhorrors",achvIndex=12)
    mapIndexes(17)=(mapname="kf-icebreaker",achvIndex=13)
    mapIndexes(18)=(mapname="kf-icecave",achvIndex=20)
    mapIndexes(19)=(mapname="kf-manor",achvIndex=1)
    mapIndexes(20)=(mapname="kf-moonbase",achvIndex=23)
    mapIndexes(21)=(mapname="kf-mountainpass",achvIndex=14)
    mapIndexes(22)=(mapname="kf-offices",achvIndex=3)
    mapIndexes(23)=(mapname="kf-sirensbelch",achvIndex=30)
    mapIndexes(24)=(mapname="kf-steamland",achvIndex=24)
    mapIndexes(25)=(mapname="kf-stronghold",achvIndex=31)
    mapIndexes(26)=(mapname="kf-suburbia",achvIndex=15)
    mapIndexes(27)=(mapname="kf-transit",achvIndex=32)
    mapIndexes(28)=(mapname="kf-waterworks",achvIndex=16)
    mapIndexes(29)=(mapname="kf-westlondon",achvIndex=0)
    mapIndexes(30)=(mapname="kf-wyre",achvIndex=7)    
    mapIndexes(31)=(mapname="kfo-steamland",achvIndex=25)
    mapIndexes(32)=(mapname="kfo-frightyard",achvIndex=27)
    mapIndexes(33)=(mapname="kfo-transit",achvIndex=33)
}
