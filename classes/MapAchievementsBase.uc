...
defaultproperties {
    ...
    mapIndexes(23)=(mapname="kf-steamland",achvIndex=24)
    mapIndexes(24)=(mapname="kf-suburbia",achvIndex=15)
    mapIndexes(25)=(mapname="kf-waterworks",achvIndex=16)
    mapIndexes(26)=(mapname="kf-westlondon",achvIndex=0)
    mapIndexes(27)=(mapname="kf-wyre",achvIndex=7)    
    mapIndexes(28)=(mapname="kfo-steamland",achvIndex=25)
    mapIndexes(29)=(mapname="kfo-frightyard",achvIndex=27)
}
